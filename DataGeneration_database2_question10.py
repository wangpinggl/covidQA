...
question_template = "What is the racial breakdown of (Case Entity) in (Location Entity)?"
...
count = 1
entities = ['Case Entity', 'Location Entity']
sql_template = "Select (Case)_Total,(Case)_White, (Case)_Black,(Case)_LatinX,(Case)_Asian,(Case)_NHPI, (Case)_Multiracial, (Case)_Other, (Case)_Unknown from db2race where date = 'given date' and state = \"State Name\" "
